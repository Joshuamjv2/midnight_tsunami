...
export default function SubBlog({title, image, article = "Lorem ipsum dolor sit, amet consectetur elit amet consecteturr adipisicing elit"}){
    return(
        <div className="flex flex-col lg:flex-row lg:h-28 gap-2 hover:scale-105 hover:duration-300 cursor-pointer">
            ...
            <div>
                <h3 className="uppercase text-sm font-bold mb-1">Title</h3>
