        ...
        <div className="flex flex-col justify-center md:flex-row gap-4 md:gap-16 w-full h-4/5 items-end">
            ...
            <div className="md:w-1/2">
                <div className="flex justify-between items-start">
                    <h5 className="uppercase font-semibold md:font-bold text-lg mb-1 hover:text-[#8001ff] md:text-3xl hover:duration-300 cursor-pointer text-[#8001ff]">{title}</h5>
                ...
                <button className="bg-[#8001ff] mt-4 py-1 px-2 text-sm tracking-wider hidden md:block text-white md:font-semibold hover:duration-300 uppercase">See More</button>
            </div>
        </div>
    )
}